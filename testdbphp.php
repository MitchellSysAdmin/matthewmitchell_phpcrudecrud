...
$conn = new mysqli('localhost', 'mmitchell', 'hotrod', 'employees' );
...
?>
<p>For more information on connecting PHP to MySQL click here:</p>
<a href=https://www.php.net/manual/en/book.mysqli.php>https://www.php.net/manual/en/book.mysqli.php</a>
